...
export class CourseServices {
    ...
    public async getEnrolledCourses(studentId: string): Promise<any[]> {
    ...
    public async seedCourses(): Promise<number> {
        ...
        if (instructor === null) {
            ...
            instructor = await this.userRepository.create(
                'instructor@elearning.com',
                passwordHash,
    ...
    public async createCourse(instructorId: string, courseData: any): Promise<any> {
